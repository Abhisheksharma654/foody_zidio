...
import 'package:random_string/random_string.dart';
 // Import the SharedPreferenceHelper from shared_pref.dart
...
class _ProfileState extends State<Profile> {
          ...
          : Container(
              child: Column(
                children: [
                  ...
                  buildActionCard(Icons.delete, "Delete Account", () {
                     AuthMethods().deleteUser();
                  }),
                  SizedBox(
                    height: 30.0,
                  ),
                  buildActionCard(Icons.logout, "LogOut", () {
                     AuthMethods().signOut();
                  })
                ],
              ),
  ...
  Widget buildActionCard(IconData icon, String label, VoidCallback onTap) {
